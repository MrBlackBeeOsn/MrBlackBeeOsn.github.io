...
export default function Formula() {
  ...
  <main className="image image2">
    ...
    <h4><a href="#spreadsheet#spreadsheet-terms"><mark className="highlight2">Spreadsheet</mark></a></h4>
    
    <h2 className="margin-y-50 text-center">What is a formula in a spreadsheet?</h2>
