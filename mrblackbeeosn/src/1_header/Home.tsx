      ...
      <article>
        ...
        <div className="margin-top-50">
          ...
          <header className="portfolio-header title">
            ...
            <h1 className="name">PLUM PROgrammer</h1>
            <div className="title"><strong>TRONG HIEU</strong></div>
            ...
            <div className="contact-info">
              ...
              <div className="contact-item">
                ...
                <Link to="https://www.tiktok.com/@mr.blackbee.ongsiengnang" className="email-link" target="_blank">
                  TikTok
                </Link>
              </div>
              ...
              <div className="contact-item">
                ...
                <Link to="https://chat.whatsapp.com/C5lPHFqASDC0sd81PKUNib" className="email-link" target="_blank">
                  WhatsApp
                </Link>
              </div>
