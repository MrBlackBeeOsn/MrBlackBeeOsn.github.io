...
export default function GitHub(): React.JSX.Element {
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <h1 className="margin-y-50 text-center" id="programming-terms">What is GitHub?</h1>
      ...
      <h3 className="margin-y-50 text-center">Storing Your Lego Sets (Code Projects):</h3>
      ...
      <h3 className="margin-y-50 text-center">Not Just Storage, It's Shareable!</h3>
      ...
      <h3 className="margin-y-50 text-center">Version Control with Git:</h3>
      ...
      <h3 className="margin-y-50 text-center">More Than Just Legos (Code):</h3>
      ...
      <h3 className="margin-y-50 text-center">Sharing with Friends (or the World!):</h3>
      ...
      <h3 className="margin-y-50 text-center">Keeping Track of Changes (Version Control):</h3>
      ...
      <h3 className="margin-y-50 text-center">More Than Just Finished Legos (Code):</h3>
      ...
      <h3 className="margin-y-50 text-center">Why Use GitHub?</h3>
