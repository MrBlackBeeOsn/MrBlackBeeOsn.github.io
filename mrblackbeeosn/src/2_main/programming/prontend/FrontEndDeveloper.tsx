...
export default function FrontEndDeveloper(): React.JSX.Element {

  const postId = "FrontEndDeveloper";
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <h1 className="margin-y-50 text-center">What is a Front-End Developer?</h1>
