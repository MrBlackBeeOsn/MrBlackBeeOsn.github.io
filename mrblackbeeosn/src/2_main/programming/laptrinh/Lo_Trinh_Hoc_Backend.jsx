...
export default function Lo_Trinh_Hoc_Backend() {
  ...
  <main className="image image2">
    ...
    <p>📌 <strong>Mục tiêu</strong>: Viết được chương trình <strong>backend</strong> đơn giản (in ra dữ liệu, xử lý form...)</p>
    ...
    <p>📌 <strong>Mục tiêu</strong>: Kết nối <strong>backend</strong> với database, lưu và truy xuất dữ liệu.</p>
    ...
    <p>📌 <strong>Mục tiêu</strong>: Tạo API cho ứng dụng frontend hoặc mobile sử dụng.</p>
    ...
    <p>📌 <strong>Mục tiêu</strong>: Làm được một ứng dụng <strong>backend</strong> hoàn chỉnh.</p>
    ...
    <p>📌 <strong>Mục tiêu</strong>: Đưa ứng dụng lên internet, chạy ổn định và bảo mật.</p>
    ...
    <p>📌 <strong>Mục tiêu</strong>: Viết <strong>backend</strong> chuyên nghiệp, tối ưu hiệu suất và bảo mật.</p>
