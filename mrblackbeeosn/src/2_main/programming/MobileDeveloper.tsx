...
export default function MobileDeveloper(): React.JSX.Element {
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <h3 className="margin-y-50 text-center">Native App Developers:</h3>
      ...
      <h3 className="margin-y-50 text-center">Cross-Platform Developers:</h3>
      ...
      <h3 className="margin-y-50 text-center">Hybrid App Developers:</h3>
