...
export default function Function(): React.JSX.Element {
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <h1 className="margin-y-50 text-center" id="programming-terms">What is a function?</h1>
      ...
      <h3 className="margin-y-50 text-center">Tools in a Toolbox:</h3>
      ...
      <h3 className="margin-y-50 text-center">Reusability:</h3>
      ...
      <h3 className="margin-y-50 text-center">Following Instructions (Parameters):</h3>
      ...
      <h3 className="margin-y-50 text-center">Why are Functions Important?</h3>
      ...
      <h3 className="margin-y-50 text-center">Making Cool Fort Parts:</h3>
      ...
      <h3 className="margin-y-50 text-center">Doing the Trick Again and Again:</h3>
