...
export default function ProgrammingLanguage(): React.JSX.Element {

  const postId = "ProgrammingLanguage";
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <h1 className="margin-y-50 text-center">What is a programming language?</h1>
