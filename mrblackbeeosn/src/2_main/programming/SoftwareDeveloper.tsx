...
export default function SoftwareDeveloper(): React.JSX.Element {

  const postId = "SoftwareDeveloper";
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <h1 className="margin-y-50 text-center">What is a Software Developer?</h1>
