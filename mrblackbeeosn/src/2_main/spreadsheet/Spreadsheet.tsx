...
export default function Spreadsheet(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<h3 className="margin-y-50 text-center">Squares = Cells:</h3>
					
			<p>Each little box in the <strong>spreadsheet</strong> is called a cell. You can put text, numbers, or even dates in these cells.</p>

			<h3 className="margin-y-50 text-center">Rows & Columns:</h3>
					
			<p>The <strong>spreadsheet</strong> has rows (going across) and columns (going down). This helps you find things easily, like on a checkerboard. Each cell is named by its row number and column letter (like A1 or C4).</p>

			<h3 className="margin-y-50 text-center">Worksheets:</h3>
					
			<p>Think of a <strong>spreadsheet</strong> like a notebook with multiple pages. Each page is called a worksheet, and you can have different worksheets to organize different things.</p>

			<h3 className="margin-y-50 text-center">Number Crunching:</h3>
					
			<p><strong>Spreadsheets</strong> are great for calculations! You can write special instructions called formulas to automatically add, subtract, multiply, or do other math with the numbers in your cells.</p>

			<h3 className="margin-y-50 text-center">More Than Numbers:</h3>
					
			<p><strong>Spreadsheets</strong> aren't just for numbers! You can also use them to make lists, track things like schedules or allowances, or even create charts to see your data visually.</p>
