        ...
        <header>
          ...
          <div className="contact-info">
            ...
            <div className="contact-item">
              ...
              <a href="https://www.instagram.com/mr.blackbee.ongsiengnang/" className="email-link" target="_blank">
                Instagram
              </a>
            </div>
            ...
            <div className="contact-item">
              ...
              <a href="https://www.facebook.com/aProgrammingBee" className="email-link" target="_blank">
                Facebook
              </a>
            </div>
          ...
          <div className="contact-info">
            ...
            <div className="contact-item">
              ...
              <a href="https://github.com/MrBlackBeeOsn" className="email-link" target="_blank">
                GitHub
              </a>
            </div>
