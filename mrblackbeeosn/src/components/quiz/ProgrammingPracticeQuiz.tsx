...
interface ProgrammingPracticeQuizProps {
	questions: Question[];
}

const ProgrammingPracticeQuiz: React.FC<ProgrammingPracticeQuizProps> = ({ questions }) => {
...
export default ProgrammingPracticeQuiz;